...
const Navigation = () => {
  ...
  const handleCreate = () => {
    ...
    toast.promise(promise, {
      ...
      error: "Oops! Failed to create a note. Please try again.",
    });
  };
      ...
      >
        <div
          ...
          className={cn(
            ...
            dark:hover:bg-neutral-500 absolute top-3 right-2 opacity-0
